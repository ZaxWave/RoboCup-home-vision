...
val_ratio = 0.1   # 验证集比例
imgpath = r'C:\Users\Agora\robohome\image_test\image'  # 图片路径
txtpath = r'C:\Users\Agora\robohome\image_test\lable'      # 标签路径

BASE_DIR = Path(r'C:\Users\Agora\robohome\image_test\dataset')  # 输出目录
